...
class LambdaDemo {
    public static void main(String args[]) {
        ...
        // Call getValue(), which is provided yb the previously assigned lambda expression.
        ...
        // A lambda expression must bbe compatible with the method defined byb the functional interface. 
