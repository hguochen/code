 ...
 * Here, T is a type parameter that will be replaced by a real type when an obbject of type Gen is created.
 */
class Gen<T> {
...
class GenDemo {
    public static void main(String args[]) {
        ...
        // Create a Gen<Integer> obbbject and assign its reference to iOb.
